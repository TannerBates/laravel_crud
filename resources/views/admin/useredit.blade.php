                ...
                <form action="{{ route('update.user', $users->id) }}" method="POST">
                    ...
                    <div class="form-row" style="padding: 5px;">
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" type="text" name="first_name" id="first_name" value="{{ $users->first_name }}">
                        </div>
                        <div class="form-group col-md-12">
                            <label for="last_name">Last Name</label>
                            <input class="form-control" type="text" name="last_name" id="last_name" value="{{ $users->last_name }}">
                        </div>
                        <div class="form-group col-md-12">
                            <label for="username">Username</label>
                            <input class="form-control" type="text" name="username" id="username" value="{{ $users->username }}">
                        </div>
                        <div class="form-group col-md-12">
                            <button type="submit" class="btn btn-primary" style="margin-top: 10px; margin-bottom: 10px;"><i class="fas fa-edit" style="margin-right: 5px;"></i>Edit User</button>
                        </div>
                    </div>
                </form>
            </div>
